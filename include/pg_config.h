...
#define PG_VERSION_STR "PostgreSQL 10.20, compiled by Visual C++ build " CppAsString2(_MSC_VER) ", 32-bit"
...
#define USE_ICU 1
#define VAL_CONFIGURE "--enable-thread-safety --enable-nls --with-ldap --with-openssl --with-ossp-uuid --with-libxml --with-libxslt --with-icu --with-python"
